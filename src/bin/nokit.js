...
if (args.length < 1 || args[0] == '?') {
    var packageInfo = nokit.utils.readJSONSync(path.resolve(__dirname, "../package.json"));
...
if (args[0] == 'create') {
    ...
    var dstPath = args[2] || "./";
    var dstFullPath = path.normalize(cwd + '/' + dstPath + '/' + appName);
    //处理源路径
    var appType = args[3] || 'nsp';
    var srcFullPath = path.resolve('../examples/' + appType);
