//sessionId 的 cookie name
var SESSION_ID_COOKIE_NAME = 'NSID';
...
SessionFilter.prototype._handleSessionId = function (context) {
    ...
    context.sessionId = req.cookie.get(SESSION_ID_COOKIE_NAME);
    if (!context.sessionId) {
        context.sessionId = self.utils.newGuid().split('-').join('');
        res.cookie.add(SESSION_ID_COOKIE_NAME, context.sessionId, {
            "httpOnly": true,
